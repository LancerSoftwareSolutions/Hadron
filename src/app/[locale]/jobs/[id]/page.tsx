    ...
    <div className="mx-auto w-full max-w-6xl px-4 py-8">
      ...
      <div className="mt-6 grid gap-8 lg:grid-cols-[1fr_22rem]">
        <article>
          ...
          <h1 dir="auto" className="display mt-3 text-3xl sm:text-4xl">{job.title}</h1>

          <dl className="mt-6 grid max-w-xl grid-cols-3 border-2 border-dashed border-line-strong bg-white">
            <div className="p-3 text-center">
              <dt className="sr-only">{t.job.type}</dt>
              <dd className="font-bold">{t.jobTypes[job.job_type]}</dd>
            </div>
            <div className="border-s-2 border-dashed border-line-strong p-3 text-center">
